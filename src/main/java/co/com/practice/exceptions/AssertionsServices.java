...
public class AssertionsServices extends AssertionError {
    ...
    public static final String QUANTITY_FIELDS_SERVICE_IS_NOT_EXPECTED = "Quantity fields service is not expected";
    ...
    public static final String THE_FIELDS_AND_VALUES_SERVICE_IS_NOT_EXPECTED = "The fields and services response is not expected";
